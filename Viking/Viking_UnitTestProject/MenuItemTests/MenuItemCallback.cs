...
namespace UnitTestProject.MenuItemTests
{
    ...
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VikingPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.Viking.GuidList.guidVikingCmdSet, (int)Company.Viking.PkgCmdIDList.cmdidMyCommand);
