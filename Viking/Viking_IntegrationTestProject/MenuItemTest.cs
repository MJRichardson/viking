...
namespace Viking_IntegrationTestProject
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Company.Viking.GuidList.guidVikingCmdSet, (int)Company.Viking.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Viking", "Company.Viking.VikingPackage");
